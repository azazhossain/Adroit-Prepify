...
const skyLight = {
    ...
    border: 'rgba(154,177,204,0.42)',
    input: 'rgba(154,177,204,0.52)',
    glass: 'rgba(255,255,255,0.68)',
    glassStrong: 'rgba(255,255,255,0.9)',
    glassBorder: 'rgba(255,255,255,0.78)',
    tabBar: 'rgba(255,255,255,0.84)',
    tabBarBorder: 'rgba(154,177,204,0.32)',
    tabActive: 'rgba(43,108,176,0.14)',
    heroStart: '#173A66',
    heroEnd: '#1C6D78',
    heroText: '#FFFFFF',
    heroMuted: '#D4EBF1',
...
const skyDark = {
    ...
    tint: '#76B5E6',
    background: '#030507',
    backgroundGlow: '#0B1624',
    foreground: '#F7FAFF',
    card: 'rgba(16,22,31,0.9)',
    cardForeground: '#F7FAFF',
    primary: '#76B5E6',
    primaryForeground: '#10213C',
    secondary: '#151D28',
    secondaryForeground: '#ECF3FC',
    muted: '#151D28',
    mutedForeground: '#B7C4D6',
    accent: '#204C4B',
    ...
    glass: 'rgba(14,19,27,0.78)',
    glassStrong: 'rgba(20,27,38,0.96)',
    glassBorder: 'rgba(148,163,184,0.26)',
    tabBar: 'rgba(7,10,15,0.93)',
    tabBarBorder: 'rgba(148,163,184,0.24)',
    tabActive: 'rgba(118,181,230,0.16)',
    heroStart: '#1B3F61',
    heroEnd: '#173B49',
    heroText: '#FFFFFF',
    heroMuted: '#C8E0E4',
